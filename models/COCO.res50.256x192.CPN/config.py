...
class Config:
    ...
    bn_train = True
    init_model = osp.join(root_dir, 'data', 'imagenet_weights', 'resnet_v1_50.ckpt')
    ...
    #det_path = osp.join(root_dir, 'data', 'COCO', 'MSCOCO', 'annotations', 'person_keypoints_trainvalminusminival2014.json')
    det_path = osp.join(root_dir, 'data', 'COCO', 'MSCOCO', 'annotations', 'person_detection_minival411_human553.json')
cfg = Config()
